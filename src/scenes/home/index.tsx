...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        {/* MAIN HEADER */}
        <div className="gap-8md:basis-3/5 z-10 mt-32 flex flex-col justify-center">
          {/* HEADINGS */}
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <p className="mt-8 text-sm">
              Unrivaled Gym. Ynparalledled Results. Unmatched Experience. World
              Class Studios to get the Body Shapes
            </p>
          </motion.div>
          {/* ACTION BUTTON */}
          <motion.div
